...
public class GameCenterController : MonoBehaviour
{
	...
	// "achievement_complete_all_levels" [ASSUMING 15 LEVELS]
	// "achievement_activate_boost"
	// "achievement_tower_upgrade"
	// "achievement_upgrade_all_towers"
	// "achievement_fully_upgrade_towers"
	...
	void Awake()
	{
		...
		if (!IsInitialized)
		{
			...
			GameCenterManager.RegisterAchievement("achievement_complete_tutorial_level");
			GameCenterManager.RegisterAchievement("achievement_complete_first_level");
			GameCenterManager.RegisterAchievement("achievement_complete_all_levels");
			GameCenterManager.RegisterAchievement("achievement_activate_boost");
			GameCenterManager.RegisterAchievement("achievement_tower_upgrade");
			GameCenterManager.RegisterAchievement("achievement_upgrade_all_towers");
			GameCenterManager.RegisterAchievement("achievement_fully_upgrade_towers");
			GameCenterManager.RegisterAchievement("achievement_earn_all_medals");
